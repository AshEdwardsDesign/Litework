jQuery(function(){
	...
	form.on('click', 'img.cfg-captcha-refresh', function(){
		...
		form.find('img.cfg-captcha-img').prop('src','cfg-form-1/inc/captcha.php?r='+Math.random());
	...
	form.on('click', '.cfgenwp-submit', function(){
		...
		jQuery.post('cfg-form-1/inc/form-validation.php',
					post,
					function(data){

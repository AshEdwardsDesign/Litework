...
if($_SESSION['captcha_img_string']['a3e383626839968bee464ec548e8c01ef13589e3'] != $_POST['captcha_input']){
	$captcha_element_id = 'cfg-element-1-8'; // will be used in merge_post
	$captcha_elementlabel_id = 'cfg-element-1-8-label'; // will be used in element_ids_values
	$json_error_array['cfg-element-1-8']['errormessage'] = $contactform_obj->cfg['form_errormessage_captcha'];
	$error_captcha = true;
}

...
$cfg['email_address'] = 'info@healthchecknorthwest.co.uk';
$cfg['email_from'] = '';
...
$cfg['form_name'] = 'Health Check North West';
...
$cfg['usernotification_inputid'] = 'cfg-element-1-3';
...
$cfg['formvalidation_required'][] = 'cfg-element-1-6';
$cfg['formvalidation_required'][] = 'cfg-element-1-7';
$cfg['formvalidation_required'][] = 'cfg-element-1-4';
$cfg['formvalidation_email'][] = 'cfg-element-1-3';
?>
...
if($_SESSION['captcha_img_string']['c89cc6991b1f80ba9d89f20a43d7521407de067f'] != $_POST['captcha_input']){
	$captcha_element_id = 'cfgen-element-1-12'; // will be used in merge_post
	$captcha_elementlabel_id = 'cfgen-element-1-12-label'; // will be used in element_ids_values
	$json_error_array['cfgen-element-1-12']['errormessage'] = $contactform_obj->cfg['form_errormessage_captcha'];
	$error_captcha = true;
}

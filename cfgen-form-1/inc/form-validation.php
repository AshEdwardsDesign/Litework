...
if($_SESSION['captcha_img_string']['49775db6ee132c8f3ae6f672ba411667b1d84ca3'] != $_POST['captcha_input']){
	$captcha_element_id = 'cfgen-element-1-6'; // will be used in merge_post
	$captcha_elementlabel_id = 'cfgen-element-1-6-label'; // will be used in element_ids_values
	$json_error_array['cfgen-element-1-6']['errormessage'] = $contactform_obj->cfg['form_errormessage_captcha'];
	$error_captcha = true;
}

...
$cfg['email_address'] = 'info@thepussinboots.co.uk';
...
$cfg['form_redirecturl'] = 'https://thepussinboots.co.uk/thankyou.html';

$cfg['adminnotification_subject'] = 'New message sent from The Puss website';

$cfg['adminnotification_hideemptyvalues'] = true;
...
$cfg['formvalidation_required'] = array('cfgen-element-1-14','cfgen-element-1-11','cfgen-element-1-9','cfgen-element-1-10','cfgen-element-1-13','cfgen-element-1-3');

$cfg['formvalidation_email'] = array('cfgen-element-1-3');

$cfg['formvalidation_terms'] = array('cfgen-element-1-8');

jQuery(function(){
	...
	jQuery("#cfgen-element-1-6").datepicker(jQuery.datepicker.regional["en-GB"]);
	jQuery("#cfgen-element-1-6").datepicker("option", "changeMonth", true);
	jQuery("#cfgen-element-1-6").datepicker("option", "changeYear", true);
	jQuery("#cfgen-element-1-6").datepicker("option", "minDate", 0);
	jQuery("#cfgen-element-1-6").datepicker("option", "firstDay", 1);
	jQuery("#cfgen-element-1-6").datepicker("option", "dateFormat", "dd/mm/yy");
	jQuery("#cfgen-element-1-6").datepicker("option", "yearRange", "-70:+5");

...
if($_SESSION['captcha_img_string']['15a0b2f51bfd460e1310836fedcb64278c47feba'] != $_POST['captcha_input']){
	$captcha_element_id = 'cfgen-element-5-11'; // will be used in merge_post
	$captcha_elementlabel_id = 'cfgen-element-5-11-label'; // will be used in element_ids_values
	$json_error_array['cfgen-element-5-11']['errormessage'] = $contactform_obj->cfg['form_errormessage_captcha'];
	$error_captcha = true;
}

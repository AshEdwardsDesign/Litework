...
if($_SESSION['captcha_img_string']['f12727ee6fa37821a6963a35d49b18e5be19ebb4'] != $_POST['captcha_input']){
	$captcha_element_id = 'cfgen-element-4-11'; // will be used in merge_post
	$captcha_elementlabel_id = 'cfgen-element-4-11-label'; // will be used in element_ids_values
	$json_error_array['cfgen-element-4-11']['errormessage'] = $contactform_obj->cfg['form_errormessage_captcha'];
	$error_captcha = true;
}

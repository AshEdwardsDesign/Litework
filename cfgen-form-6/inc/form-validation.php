...
if($_SESSION['captcha_img_string']['2ea115cdab2786c664d750f25c67b6690fadd204'] != $_POST['captcha_input']){
	$captcha_element_id = 'cfgen-element-6-11'; // will be used in merge_post
	$captcha_elementlabel_id = 'cfgen-element-6-11-label'; // will be used in element_ids_values
	$json_error_array['cfgen-element-6-11']['errormessage'] = $contactform_obj->cfg['form_errormessage_captcha'];
	$error_captcha = true;
}

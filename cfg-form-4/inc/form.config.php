...
$cfg['email_address'] = 'info@monstermunchiez.co.uk';
$cfg['email_from'] = '';
...
$cfg['smtp_password'] = '';
$cfg['timezone'] = 'UTC';
$cfg['form_name'] = 'Monster Munchiez';
...
$cfg['usernotification_inputid'] = 'cfg-element-4-3';
...
$cfg['formvalidation_required'][] = 'cfg-element-4-7';
$cfg['formvalidation_required'][] = 'cfg-element-4-6';
$cfg['formvalidation_required'][] = 'cfg-element-4-4';
$cfg['formvalidation_email'][] = 'cfg-element-4-3';
?>
...
if($_SESSION['captcha_img_string']['c8b9b96836f2de57bd9a3995740f2a170e0884a7'] != $_POST['captcha_input']){
	$captcha_element_id = 'cfg-element-3-10'; // will be used in merge_post
	$captcha_elementlabel_id = 'cfg-element-3-10-label'; // will be used in element_ids_values
	$json_error_array['cfg-element-3-10']['errormessage'] = $contactform_obj->cfg['form_errormessage_captcha'];
	$error_captcha = true;
}

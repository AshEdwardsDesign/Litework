...
$cfg['form_name'] = 'Service your smile (Contact us page)';
...
$cfg['adminnotification_subject'] = 'New message sent from your website (contact page)';
$cfg['adminnotification_hideemptyvalues'] = false;
$cfg['adminnotification_hideformurl'] = true;
$cfg['usernotification_inputid'] = 'cfg-element-3-3';
...
$cfg['formvalidation_required'][] = 'cfg-element-3-6';
$cfg['formvalidation_required'][] = 'cfg-element-3-7';
$cfg['formvalidation_required'][] = 'cfg-element-3-9';
$cfg['formvalidation_required'][] = 'cfg-element-3-11';
$cfg['formvalidation_required'][] = 'cfg-element-3-4';
$cfg['formvalidation_email'][] = 'cfg-element-3-3';
?>
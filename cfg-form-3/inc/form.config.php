...
$cfg['email_address'] = 'info@nonsurgicalbodyclinic.co.uk';
$cfg['email_from'] = 'Non Surgical Body Clinic';
...
$cfg['smtp_password'] = '';
$cfg['timezone'] = 'UTC';
$cfg['form_name'] = 'Non Surgical Body Clinic';
...
$cfg['formvalidation_email'][] = 'cfg-element-3-1';
?>